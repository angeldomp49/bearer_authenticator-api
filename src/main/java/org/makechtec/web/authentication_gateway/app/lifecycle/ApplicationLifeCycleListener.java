...
public class ApplicationLifeCycleListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    @Autowired
    public ApplicationLifeCycleListener(RateLimitRegistry rateLimitRegistry, CacheSystemTable cacheSystemTable, RandomStringGenerator randomStringGenerator, ConnectionPool connectionPool) {
