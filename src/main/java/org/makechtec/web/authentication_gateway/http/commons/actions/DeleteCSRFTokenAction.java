...
public class DeleteCSRFTokenAction implements HttpAsyncAction {
    ...
    public DeleteCSRFTokenAction(CSRFTokenHandler csrfTokenHandler, CommonResponseBuilder commonResponseBuilder) {
    ...
    public void perform(EnvironmentContext context) {
        try {
            this.csrfTokenHandler.deleteCSRFToken((String) context.getItem("xCsrfToken"));
