package org.makechtec.web.authentication_gateway.resources.application.validation;
...
public class ApplicationRateLimitValidator {
    ...
    public ApplicationRateLimitValidator(ConnectionPool connectionPool, RateLimitRegistry registry) {
        this.connectionPool = connectionPool;
        this.registry = registry;
    }

    public boolean hasAttemptsThisClient(String applicationIP, String userAgent, String rateLimitTitle) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        try {
            ...
            var queryWithTimeFilter = """
                    ...
                    FROM atepoztli__authentication_service__schema.application_attempts
    ...
    public void pushAttemptToThisClient(String applicationIP, String userAgent) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        try {

            new WithPoolEngine<Void>(connectionPool)
                    .isPrepared()
                    .queryString("""
                            INSERT INTO atepoztli__authentication_service__schema.application_attempts(application_ip, user_agent, created_at)
                            VALUES(?,?, NOW());
                            """)
                    .addParamAtPosition(1, applicationIP, ParamType.TYPE_STRING)
                    .addParamAtPosition(2, userAgent, ParamType.TYPE_STRING)
